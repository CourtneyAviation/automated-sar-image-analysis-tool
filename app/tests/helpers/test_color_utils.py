...
def test_getColorRange_normal_case():
...
def test_getColorRange_exceed_max():
...
def test_getColorRange_below_min():
    base_color = (10, 20, 30)
...
def test_getColorRange_exact_bounds():
    base_color = (0, 0, 0)
...
def test_getColorRange_upper_bounds():
